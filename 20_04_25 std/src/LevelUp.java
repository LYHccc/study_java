...
public class LevelUp {
    private static int maxAppNum(int a, int b){
    ...
    private static int countFinal(int[] arr, int skill){
        for(int a : arr){
            if(skill >= a){
                skill += a;
            }else{
                skill += maxAppNum(a, skill);
            }
        }
        return skill;
    }
    ...
    public static void main(String[] args){
        ...
        while(scanner.hasNextInt()) {
            ...
            System.out.println(countFinal(arr, skillCount));
        }
    }
}
